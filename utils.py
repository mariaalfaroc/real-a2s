...
if __name__ == '__main__':
    ...
    Y = [['*clefG2', '*k[f#c#g#]', '*M2/4', '8', '.', 'aa', '32', 'gg', '#', '32', 'ff', '#', '16', 'ee', '16', 'ff', '#', '16', 'ee', '16', 'dd', '=', '16', 'cc', '#', '16', 'a', '16', 'dd', '16', 'a', '16', 'ee', '16', 'a', '16', 'ff', '#', '16', 'a', '=']]
    YPRED = [['*clefG2', '*k[f#c#]', '*M4/4', '=', '8', '.', 'aa', '16', '#', '16', '#', '16', 'ee', '16', 'ff', '#', '16', 'ee', '16', 'dd', '16', 'cc', '#', '16', 'a', '16', 'dd', '16', 'a', '16', 'ee', '16', 'a', '16', 'ff', '#', '16', 'a', '=']]

    out = decoupledKern2Kern(YPRED[0])
    print("hello")