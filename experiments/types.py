...
from my_utils.generators import load_data_from_fold_file, train_data_generator
    ...
    *,
    ...
    for fold in sorted(os.listdir(PARTITIONS_PATH)):
        if not fold.startswith("."):
            ...
            # Get test filepaths
            XTestFiles, YTestFiles = load_data_from_fold_file(
