...
class RNN(nn.Module):
    def __init__(self, input_size: int, output_size: int) -> None:
        ...
        self.blstm = nn.LSTM(self.input_size, 256, num_layers=2, batch_first=True, dropout=0.5, bidirectional=True)
...
class CRNN(nn.Module):
    def __init__(self, output_size: int) -> None:
        ...
        self.encoder = CNN()
        # RNN
        input_size = self.encoder.out_channels * (IMG_HEIGHT // self.encoder.height_reduction)
